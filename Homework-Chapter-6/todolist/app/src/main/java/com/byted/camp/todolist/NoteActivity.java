...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(id != -1)
        {
            ...
            radioGroup.check(getPriorityButton(priority));
            ...
            addBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (succeed) {
                        Toast.makeText(NoteActivity.this,
                                "Note editted", Toast.LENGTH_SHORT).show();
    ...
    private boolean editNote2Database(long id,String content, Priority priority){
        ...
        values.put(TodoNote.COLUMN_DATE, System.currentTimeMillis());
        values.put(TodoNote.COLUMN_PRIORITY, priority.intValue);
        String whereClause= TodoNote._ID + " = ?";//where子句，表示要操作的位置
    ...
    private int getPriorityButton(int id){
        switch (id) {
            case 2:
